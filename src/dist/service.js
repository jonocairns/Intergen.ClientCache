...
(function (app) {
    ...
    (function (services) {
        ...
        })(services.StorageType || (services.StorageType = {}));
        var StorageType = services.StorageType;
        ...
        services.IntergenStorageService = IntergenStorageService;
        ...
        angular.module('app.services').factory('app.services.IntergenStorageService', factory);
