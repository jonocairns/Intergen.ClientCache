...
module Tests {
  describe('Storage Service test: ', function() {
    ...
    it('should compute a hash correctly', () => {
    ...
    it('should return a 0 hash if an empty string is given', () => {
    ...
    it('should not override if the hash is the same', () => {
      var key = 'testKey';
      var value = 'derp';
    ...
    it('should override if the hash is different', () => {
      var key = 'testKey';
      var value = 'derp';
    ...
    it('should pull from localStorage if it doesnt exist in cacheFactory', () => {
    ...
    it('should return undefined if item doesnt exist in storage', () => {
      var item = storage.get('key');

      expect(item).toBeUndefined();
    });

    it('should decompress from localStorage when get is called', () => {
